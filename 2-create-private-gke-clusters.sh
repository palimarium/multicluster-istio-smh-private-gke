...
--master-authorized-networks 172.20.0.0/20,172.21.0.0/20,10.16.48.0/20 --num-nodes "3" --release-channel=rapid &
...
--master-authorized-networks 172.20.0.0/20,172.21.0.0/20,10.16.32.0/20 --num-nodes "3" --release-channel=rapid &
